...
customElements.get('pay-toast') || customElements.define('pay-toast', LitToast);
customElements.get('pay-toast-container') ||
  customElements.define('pay-toast-container', LitToastContainer);

declare global {
  interface HTMLElementTagNameMap {
    'pay-toast': LitToast;
    'pay-toast-container': LitToastContainer;
  }
}
...
export class ToastManager {
  ...
  constructor() {
    const container = this.body.querySelector('pay-toast-container');
